            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col text-left">
                        <h1 className="text-3xl md:text-5xl font-bold text-gray-300 tracking-tight">
                            The
                        </h1>
                        <h1 className="text-3xl md:text-5xl font-bold text-red-400 tracking-tight">
                            Dynamic Fitness
                        </h1>
                        <span className="text-sm md:text-base text-gray-300 tracking-widest uppercase mt-2">
                            Unisex Gym
                        </span>
                    </div>
                </div>
